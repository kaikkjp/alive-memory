...
class SelfModelManager:
    ...
    async def update_behavioral_signature(
    ...
    async def update_relational_stance(
        self, stance: dict[str, float]
    ) -> SelfModel:
    ...
    def needs_narrative_regen(
        self, model: SelfModel, threshold: float = 0.2
    ) -> bool:
