...
| Area | Files | Lines |
|------|-------|-------|
| Core engine (*.py root) | 17 | ~6,616 |
| Pipeline (pipeline/*.py) | 31 | ~7,381 |
| API | 2 | ~463 |
| Config | 5 | ~428 |
| Models | 4 | ~636 |
| Scripts | 7 | ~815 |
...
| Docs (*.md) | 29 | ~17,419 |
| Deploy | 7 | ~559 |
| **Total** | **~195** | **~53,295** | **~174** | **~44,878** | **~173** | **~44,376** | **~172** | **~43,587** | **~171** | **~42,950** | **~163** | **~40,552** | **~173** | **~44,586** | **~172** | **~43,816** | **~170** | **~43,252** | **~166** | **~41,956** | **~165** | **~41,631** | **~148** | **~33,417** |
