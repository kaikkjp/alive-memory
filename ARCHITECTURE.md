...
| Area | Files | Lines |
|------|-------|-------|
| Core engine (*.py root) | 16 | ~6,816 |
| Pipeline (pipeline/*.py) | 31 | ~7,705 |
| API | 2 | ~664 |
| Config | 5 | ~428 |
| Models | 4 | ~636 |
| Scripts | 7 | ~941 |
| Tests | 70 | ~18,689 |
| Frontend (window/src/) | 48 | ~5,139 |
| Docs (*.md) | 14 | ~12,216 |
| Deploy | 6 | ~505 |
| **Total** | **~203** | **~53,475** | **~207** | **~61,062** | **~207** | **~61,062** | **~207** | **~61,062** | **~206** | **~60,690** | **~205** | **~60,540** | **~204** | **~60,332** | **~204** | **~60,279** | **~204** | **~60,064** | **~203** | **~59,801** | **~177** | **~46,447** |
