...
| Area | Files | Lines |
|------|-------|-------|
| Core engine (*.py root) | 16 | ~6,517 |
| Pipeline (pipeline/*.py) | 31 | ~7,423 |
| API | 2 | ~430 |
| Config | 5 | ~428 |
| Models | 4 | ~637 |
| Scripts | 6 | ~629 |
...
| Docs (*.md) | 12 | ~9,028 |
| Deploy | 6 | ~505 |
| **Total** | **~173** | **~44,376** | **~172** | **~43,587** | **~171** | **~42,950** | **~163** | **~40,552** | **~173** | **~44,586** | **~172** | **~43,816** | **~170** | **~43,252** | **~166** | **~41,956** | **~165** | **~41,631** | **~148** | **~33,417** |
