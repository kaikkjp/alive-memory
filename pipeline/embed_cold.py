...
import db
from pipeline.embed import embed, embed_model_name, embed_session
...
async def embed_new_cold_entries() -> dict:
    ...
    # Reuse a single aiohttp session for the entire batch (avoids
    # creating 100+ TCP connections for sequential embedding calls).
